...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Nhịp tim của bé nè 🥺💕 " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp; Nhịp tim của bé như vậy là vì ... 🥺';
document.querySelector('.Description .modal-body').innerHTML = 'Bé iu heo nhắm. Bé nhớ heo nữa... Nhớ lắm 🥺🥺🥺<i class="fas fa-heart"></i> ';
